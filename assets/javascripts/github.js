...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {var Profiles;

	Profiles = __webpack_require__(1);

	React.render(React.createElement(Profiles, null), document.getElementById('example'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {var View;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {var GHUser, Search, TWIUser;

	Search = __webpack_require__(159);

	GHUser = __webpack_require__(160);

	TWIUser = __webpack_require__(161);

	module.exports = {
	  render: function(component) {
	    return React.createElement("div", null, React.createElement(Search, {
	      "onSearch": component.searchUser
	    }), React.createElement(GHUser, {
	      "user": component.state.ghuser
	    }), React.createElement(TWIUser, {
	      "user": component.state.twiuser
	    }));
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  onSubmit: function(e) {
	    ...
	    return $.getJSON('http://twitter-api-v1-1.herokuapp.com/users/show?screen_name=' + this.state.searchName, this.twitterUserFound);
	  },
	  githubUserFound: function(json) {
	    return this.props.onSearch(json, 'github');
	  },
	  twitterUserFound: function(json) {
	    return this.props.onSearch(json, 'twitter');
	  }
	});

	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(165)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  profileImageUrl: function() {
	    ...
	    return this.props.user.profile_image_url.replace(/_normal/, '');
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {module.exports = {
	  render: function(component) {
	    ...
	    }, React.createElement("h3", null, "Github name: ", component.props.user.name), React.createElement("img", {
	      "src": component.props.user.avatar_url,
	      "width": "200",
	      "height": "200"
	    }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(React) {module.exports = {
	  render: function(component) {
	    ...
	    }, React.createElement("h3", null, "Twitter name: ", component.props.user.name), React.createElement("img", {
	      "src": component.profileImageUrl(),
	      "height": "200"
	    }));
	  }
	};
	...
	/* WEBPACK VAR INJECTION */(function(React) {module.exports = {
	  render: function(component) {
	    return React.createElement("form", {
	      ...
	      "value": component.state.searchName,
	      "onChange": component.onNameChange,
	      "autoFocus": true
